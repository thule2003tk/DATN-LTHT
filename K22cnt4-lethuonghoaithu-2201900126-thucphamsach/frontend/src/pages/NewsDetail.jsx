...
function NewsDetail() {
    ...
    return (
        <div className="bg-light min-vh-100">
            ...
            {loading ? (
                <div className="text-center py-5 min-vh-100 d-flex flex-column align-items-center justify-content-center text-success">
                    <Spinner animation="border" variant="success" />
                    <p className="mt-2 fw-bold">Đang tải tin tức...</p>
                </div>
            ) : !news ? (
                <div className="text-center py-5 min-vh-100 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <Button variant="success" onClick={() => navigate("/tin-tuc")} className="mt-3">
                        Quay lại danh sách
                    </Button>
                </div>
            ) : (
                        ...
                        <Row>
                            <Col lg={8}>
                                <div className="news-content-wrap bg-white p-4 p-md-5 rounded shadow-sm mb-4">
                                    <div
                                        onClick={() => navigate(-1)}
                                        className="text-success text-decoration-none mb-4 d-inline-block fw-bold cursor-pointer"
