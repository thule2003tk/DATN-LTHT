    ...
    return (
        <Container fluid className="p-4">
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h2 className="text-success fw-bold mb-0">🖼️ Quản lý Banner Trang chủ</h2>
                            ...
                            {filteredBanners.length === 0 ? (
                                <tr>
                                    <td colSpan="7" className="text-center py-5">
                                        <div className="text-muted fs-5">🔍 Không tìm thấy banner nào phù hợp</div>
                                    </td>
                                </tr>
                            ) : (
                                filteredBanners.map((b) => (
                                    <tr key={b.ma_banner}>
                                        ...
                                        <td>
                                            ...
                                            <Badge bg={
                                                b.type === 'main' ? 'primary' :
                                                    b.type === 'secondary' ? 'warning' :
                                                        b.type === 'dual' ? 'danger' :
                                                            b.type === 'category' ? 'success' : 'info'
                                            } size="sm" className="me-2">
                                                {
                                                    b.type === 'main' ? 'Banner chính' :
                                                        b.type === 'secondary' ? 'Banner phụ dài' :
                                                            b.type === 'dual' ? 'Banner đôi' :
                                                                b.type === 'category' ? 'Banner danh mục' : 'Banner giữa'
                                                }
                                            </Badge>
                                            <small className="text-muted d-block">{b.description}</small>
                                        </td>
                                        <td>
                            ...
                            <Col md={6}>
                                ...
                                <Form.Group className="mb-3">
                                    ...
                                    <Form.Select value={formData.type} onChange={e => setFormData({ ...formData, type: e.target.value })}>
                                        <option value="main">Banner chính (Trang chủ)</option>
                                        <option value="secondary">Banner phụ dài (Trang chủ)</option>
                                        <option value="dual">Banner đôi (Trang chủ)</option>
                                        <option value="middle">Banner giữa (Trang chủ)</option>
                                        <option value="category">Banner Danh mục (Trang Sản phẩm)</option>
                                    </Form.Select>
                                </Form.Group>
                                <Form.Group className="mb-3">
