...
import { Table, Container, Alert, Spinner, Button, Modal, Form, Badge, InputGroup } from "react-bootstrap";
...
function AdminOrders() {
  ...
  const filteredOrders = orders.filter(o =>
    o.ma_donhang.toLowerCase().includes(searchTerm.toLowerCase()) ||
    o.hoten_nhan.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  return (
    <Container className="my-5">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="text-success mb-0">📦 Quản lý đơn hàng</h2>
          ...
          {filteredOrders.length === 0 && (
            <tr>
              <td colSpan="7" className="text-center py-5">
                <div className="text-muted fs-5">🔍 Không tìm thấy đơn hàng nào phù hợp</div>
              </td>
            </tr>
          )}
